...
namespace Umja
{
    public class Parser
    {
        ...
        public void Parse(string graphml, string csvPath)
        {
            using (StreamReader reader = new StreamReader(graphml))
            {
        ...
        private void Write_To_CSV(string csvPath)
        {
            var path = $"{csvPath}\\filteredData.csv";
            var package = "";
            var csv_Line = "";
            var class_Type = "";
